...
def setup_test_database(db_config):
    ...
    try:
        ...
        VALUES 
            ('Test Paper 1', 'Perovskite materials are used in solar cells.', '[0.1, 0.2, 0.3]'::vector),
            ('Test Paper 2', 'Perovskites have unique electronic properties.', '[0.4, 0.5, 0.6]'::vector),
            ('Test Paper 3', 'The efficiency of perovskite solar cells has improved.', '[0.7, 0.8, 0.9]'::vector)
