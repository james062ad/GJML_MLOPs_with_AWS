...
def test_generate_response_basic(
    mock_query, mock_chunks, mock_config, mock_generate_response, mock_settings
):
    """
...
def test_generate_response_empty_chunks(
    mock_query, mock_config, mock_generate_response, mock_settings
):
    """
...
def test_generate_response_high_temperature(
    mock_query, mock_chunks, mock_generate_response, mock_settings
):
    """
...
# ─────────────────────────────────────────────────────────────
def test_generate_response_long_query(mock_chunks, mock_generate_response, mock_settings):
    """
